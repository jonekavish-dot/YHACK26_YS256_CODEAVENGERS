...
- **Scientific Benchmark Forensics**:
  ...
  - Benchmark result with fixed seed (`seed=42`, 20 trials): MIRA achieves 100% arrival (vs 85% baseline), 0 collisions (vs 3 baseline), 3 near-misses (vs 37 near-misses for baseline, -91.9%), reducing physical risk exposure from 25.5 to 2.2 (-91.4%).
